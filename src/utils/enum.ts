...
export enum EVENT_TYPE {
  ...
  // ===== Quiz 答题系统事件 =====
  /** 答案正确 */
  QUIZ_ANSWER_CORRECT = "quiz:answerCorrect",
  /** 答案错误 */
  QUIZ_ANSWER_WRONG = "quiz:answerWrong",
  /** 生成防御塔 */
  QUIZ_SPAWN_TOWER = "quiz:spawnTower",
  /** 升级防御塔 */
  QUIZ_UPGRADE_TOWER = "quiz:upgradeTower",
  /** 生成特殊防御塔 */
  QUIZ_SPAWN_SPECIAL_TOWER = "quiz:spawnSpecialTower",
  /** 升级所有防御塔 */
  QUIZ_UPGRADE_ALL_TOWERS = "quiz:upgradeAllTowers",
  /** 金币奖励 */
  QUIZ_GOLD_REWARD = "quiz:goldReward",
  /** 分数变化 */
  QUIZ_SCORE_CHANGE = "quiz:scoreChange",
  /** 放置失败 */
  QUIZ_PLACEMENT_FAILED = "quiz:placementFailed",
  /** 全部题目完成 */
  QUIZ_ALL_COMPLETED = "quiz:allCompleted",

  // ===== Quiz 关卡系统事件 =====
  /** 关卡开始 */
  QUIZ_LEVEL_START = "quiz:levelStart",
  /** 关卡内所有题目完成 */
  QUIZ_LEVEL_COMPLETE = "quiz:levelComplete",
  /** 获得防御塔奖励（加入塔库） */
  QUIZ_TOWER_EARNED = "quiz:towerEarned",
  /** 开始部署防御塔（从塔库选中） */
  QUIZ_DEPLOY_START = "quiz:deployStart",
  /** 防御塔部署成功 */
  QUIZ_DEPLOY_TOWER = "quiz:deployTower",
  /** 取消防御塔部署 */
  QUIZ_DEPLOY_CANCELLED = "quiz:deployCancelled",
  /** 波次开始 */
